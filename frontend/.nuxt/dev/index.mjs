...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {},
  "recipeApiBase": "http://localhost:8181/api"
};
const envOptions = {
  prefix: "NITRO_",
...
const __JxtfkVW0q_OGmyajBAmKgMGykLdC6b2Zjdv_BIkq8 = (function(nitro) {
...
const rootDir = "/Users/ritika.sharma/Documents/Personal/recipe-finder/frontend";
...
const plugins = [
  __JxtfkVW0q_OGmyajBAmKgMGykLdC6b2Zjdv_BIkq8,
...
const _qGUtT3 = eventHandler((event) => {
...
const _lazy__efl14 = () => Promise.resolve().then(function () { return search_post$1; });
const _lazy_tPCMAX = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _qGUtT3, lazy: false, middleware: true, method: undefined },
  { route: '/api/recipes/search', handler: _lazy__efl14, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_tPCMAX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_tPCMAX, lazy: true, middleware: false, method: undefined }
];
